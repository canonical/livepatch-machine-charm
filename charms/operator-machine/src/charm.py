...
from constants.statuses import LIVEPATCH_NOT_INSTALLED_ERROR, CHECKING_DB_VERS, INSTALLING, SUCCESSFUL_INSTALL, AWAIT_POSTGRES_RELATION
    ...
    def _config_changed(self, event: ConfigChangedEvent):
        ...
        if self._check_install_and_relations() and self._check_schema_upgrade_required(event):
            ...
            try:  
                ...
                logging.error("error occured when attempting to set snap configuration value %s", e)
